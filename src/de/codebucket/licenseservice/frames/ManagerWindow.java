...
public class ManagerWindow extends JFrame 
{
	...
	public ManagerWindow(final MainWindow main) 
	{
		...
		setResizable(false);
		setTitle("Add Product - MyLicenseControl v1.5.2");
		...
		btnAdd.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				if(response == null)
				{
					JOptionPane.showMessageDialog(ManagerWindow.this, "An internal error has occoured while executing the process!", "MyLicenseControl v1.5.2", JOptionPane.ERROR_MESSAGE);
					main.closeWindow(ManagerWindow.this);
					main.reload();
					return;
				}
				...
				{
					JOptionPane.showMessageDialog(ManagerWindow.this, response.b(), "MyLicenseControl v1.5.2", JOptionPane.ERROR_MESSAGE);
					main.closeWindow(ManagerWindow.this);
					main.reload();
					return;
				}
				
				JOptionPane.showMessageDialog(ManagerWindow.this, response.b(), "MyLicenseControl v1.5.2", JOptionPane.INFORMATION_MESSAGE);
				main.closeWindow(ManagerWindow.this);
				main.reload();
				return;
			}
