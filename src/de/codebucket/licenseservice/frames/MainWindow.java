...
public class MainWindow extends JFrame implements Runnable
{
	...
	private void createWindow()
	{
		...
		setTitle(client.getUsername() + "@" + client.getAddress().getHostAddress() + " - MyLicenseControl v1.5.4");
		...
		btnRemoveLicense.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				if(!s.isSelectionEmpty())
				{
					int action = JOptionPane.showConfirmDialog(MainWindow.this, "Do you really want to remove this license?", "MyLicenseControl v1.5.4", JOptionPane.YES_NO_OPTION);  
		...
		addWindowListener(new WindowAdapter() 
		{
			...
			{
				int action = JOptionPane.showConfirmDialog(MainWindow.this, "Do you really want to disconnect from the server?", "MyLicenseControl v1.5.4", JOptionPane.YES_NO_OPTION);  
			    if(action == JOptionPane.YES_OPTION)
			    {
	...
	{
		setTitle("Not connected - MyLicenseControl v1.5.4");
		try 
		{
			Thread.sleep(150L);
		} 
