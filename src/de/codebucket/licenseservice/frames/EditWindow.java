...
public class EditWindow extends JFrame 
{
	...
	public EditWindow(final MainWindow main, final String product, final String key, final String uuid) 
	{
		...
		setResizable(false);
		setTitle("Edit License - MyLicenseControl v1.5.4");
					...
					public void run() 
					{
						...
						if(res == JFileChooser.APPROVE_OPTION)
						{
							...
							if(!file.exists())
							{
								...
								{
									JOptionPane.showMessageDialog(EditWindow.this, "An error occurred while creating a new license file.", "MyLicenseControl v1.5.4", JOptionPane.ERROR_MESSAGE);
									return;
								}
							}
							...
							JOptionPane.showMessageDialog(EditWindow.this, "License file sucessfully created. (" + file.getAbsolutePath() + ")", "MyLicenseControl v1.5.4", JOptionPane.INFORMATION_MESSAGE);
						}
					}
				}.start();
			}
		...
		btnReset.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e)
			{
				int action = JOptionPane.showConfirmDialog(EditWindow.this, "Do you really want to reset this license?", "MyLicenseControl v1.5.4", JOptionPane.YES_NO_OPTION);  
			    if(action == JOptionPane.YES_OPTION)
			    {
			    	...
			    	if(sucess == true)
			    	{
			    		JOptionPane.showMessageDialog(EditWindow.this, "License key '" + key + "' was sucessfully reset!", "MyLicenseControl v1.5.4", JOptionPane.INFORMATION_MESSAGE);
	...
	private void loadData()
	{
		...
		{	
			...
			public void run()
			{
				...
				{
					JOptionPane.showMessageDialog(EditWindow.this, "License for product '" + product.getName() + "' with license key '" + key.getKey() + "' not exists.", "MyLicenseControl v1.5.4", JOptionPane.WARNING_MESSAGE);
